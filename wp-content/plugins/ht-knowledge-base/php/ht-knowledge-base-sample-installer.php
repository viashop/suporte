    ...
    class HT_Knowledge_Base_Sample_Installer {
        ...
        */
        function add_sample_categories(){
            ...
            $name = __('Heroic Knowldge Base Plugin', 'ht-knowledge-base');
            $this->add_ht_kb_category($name);
        }
        ...
        */
        function add_sample_articles(){
            ...
            $this->add_sample_ht_kb_article('Knowledge Base WordPress Plugin', $this->get_sample_info_content(), 'Heroic Knowldge Base Plugin', array('tips', 'kb', 'tips') );
        }
        ...
        */
        function add_sample_ht_kb_article($title = '', $content = '', $category = '', $tags = array() ){
            ...
            if( $new_article_id > 0 ){
                ...
                wp_set_object_terms( $new_article_id, $category_slug, 'ht_kb_category' );

                //ht_kb_tags
                foreach ($tags as $key => $tag) {
                   $tag_slug = sanitize_title($tag);
                    wp_set_object_terms( $new_article_id, $tag_slug, 'ht_kb_tag' );
                }
            }
