    ...
    class HT_Knowledge_Base_Welcome {
        ...
        */
        function ht_kb_welcome_screen(){
            ...
            $ht_kb_state_text = ($article_count>0) ? __('and it looks like there are already a few articles', 'ht-knowledge-base') : __('though it doesn’t have anything in it at the moment', 'ht-knowledge-base') ;
                   
            ?>
            <!-- .about-wrap -->
            <div class="wrap about-wrap">

                <h1><?php _e('Welcome to the Heroic Knowledge Base');  ?></h1>
                ...
                <div class="feature-section col two-col">
                    ...
                    <div class="last-feature">
                        ...
                        <?php else: ?>
                            <p><?php printf(__('<b>Important:</b> To enable automatic updates and support for this site, be sure to enter your license key on the <a href="%s" target="_blank">license and updates tab</a> of your Knowledge Base settings, this ensures you have the latest and supported version of the plugin.', 'ht-knowledge-base'), admin_url('edit.php?post_type=ht_kb&page=_ht_kb_options&tab=6')); ?></p>
                        <?php endif; ?>
